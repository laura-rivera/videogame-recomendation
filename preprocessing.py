...
def main():
    ...
    # Mostrar rangos de características
    print("\nRangos de características:")
    for col in ['playtime_hours', 'win_rate', 'pvp_matches', 'skill_level']:
        if col in df_processed.columns:
            print(f"  - {col}: [{df_processed[col].min():.2f}, {df_processed[col].max():.2f}]")
